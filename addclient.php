...
<head>
    ...
    <title>NUS Consulting Group | Creation of Client Company </title>
...
<body>
    <div class = "userform", id="popup-1">
        <form action="postclientcompanydata.php" method="POST">
            <header class="head">
                <a class="addnewparent">New Client</a>
        ...
        <hr width="450px" color="whitegrey" >
         <br>
            <label for ="clienttitle" class="">New client</label>
            <br>
            <input autocomplete="off" type="text" name="clientcompany" class="clientcomoany" id="clientcomoanyname" placeholder="Enter the client company's name " onkeyup="isEmpty()" required>
            <br>
            <label for ="parentEntityname">Parent company</label>
            <br>
            ...
            <label for="country" class="countryname">Country</label>
            ...
            <div class="buttonSection">
                <input name="cancel" value="Cancel" type="reset" class="cancelclient" onclick='window.history.go(-1);'>
                <input value="Create client" class="createclient" id="enable_button" type="submit" >
            <br>
            </div> 
        </form>
    </div>
